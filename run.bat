java -classpath .;compiler\java-cup-11a.jar compiler.Main compiler\milestones\milestone1.java output\milestone1.asm
java -classpath .;compiler\java-cup-11a.jar compiler.Main compiler\milestones\milestone2.java output\milestone2.asm
